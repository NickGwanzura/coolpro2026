...
import type { ApprovedSupplier, RewardItem, SupplierRegistration } from '@/types/index';
...
export default function RewardsHub({ adminView = false }: { adminView?: boolean }) {
        ...
        <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
          <article className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="space-y-3">
              {REWARDS.map(reward => (
                <div key={reward.id} className="flex items-center justify-between rounded-2xl border border-gray-200 bg-gray-50 px-4 py-4">
                  <div>
  ...
  return (
    <div className="space-y-8">
      <section className="overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white shadow-xl">
        <div className="relative p-8">
          ...
          <div className="relative z-10 flex flex-col items-center justify-between gap-8 md:flex-row md:text-left">
            ...
            <div className="min-w-[180px] rounded-2xl border border-white/10 bg-white/10 p-6 text-center backdrop-blur-md">
      ...
      <section className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {REWARDS.map((reward) => {
          ...
          return (
            <article
              key={reward.id}
              className="group flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                ...
                <div className="mt-auto flex items-center justify-between pt-4">
                  ...
                  <button
                    disabled={!canRedeem}
                    className={`inline-flex items-center gap-1 rounded-xl px-4 py-2 text-sm font-semibold transition-all ${
                      canRedeem
...
function OverviewCard({
  ...
  return (
    <article className={`rounded-2xl border border-gray-200 bg-white shadow-sm ${compact ? 'p-4' : 'p-5'}`}>
