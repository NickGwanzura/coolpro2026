      ...
      <section className="bg-white border border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
          <div className="bg-gray-50 p-6 font-mono text-sm leading-relaxed mb-6">
            ...
            <span className="text-blue-600 ml-8">[Core Services]</span> (Learning Hub, Commercial Refrigeration System Sizing Tool, Compliance Hub)<br/>
      ...
      <section className="bg-white border border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
          <div className="bg-gray-50 border border-gray-200 p-6 ">
            ...
            <code className="block bg-white p-4 text-blue-600 font-mono text-sm mb-4 border border-gray-200">
